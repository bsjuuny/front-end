...
var MotionDisplay = function(canvas, imageCanvas, field, numParticles, opt_projection) {
	...
	this.backgroundAlpha = 'rgba(' + this.rgb + ', .2)';
...
function init() {
	loading = false;
	var timestamp = windData.timestamp || '';
	...
	var mapProjection = new ScaledAlbers(500, 50, canvas.height, -112.5, 18);
	...
	var display = new MotionDisplay(canvas, null, field, numParticles, mapProjection);
	...
	mapAnimator = new Animator(null, isAnimating, null);
	...
	//var hovercard = new MotionDetails(null, null, field, mapProjection, mapAnimator);
